...
using ViruZLauncher.Utilities.Handlers;
using ViruZLauncher.Utilities.Utility.Events;
using NGettext;
using SysPath = System.IO.Path;

namespace ViruZLauncher.Utilities.Interface
{
	public partial class MainWindow : Window
	{
		...
		/// </summary>
		private readonly ICatalog LocalizationCatalog = new Catalog("ViruZLauncher", "./Content/locale");
		...
		private async void OnGenerateViruZLauncherManifestButtonClicked(object sender, EventArgs e)
		{
			await GenerateManifestAsync(EManifestType.ViruZLauncher);
		}
		...
		private async Task GenerateManifestAsync(EManifestType manifestType)
		{
			...
			this.GenerateViruZLauncherManifestButton.Sensitive = false;
			...
			this.GenerateViruZLauncherManifestButton.Sensitive = true;
		}
	}
}
