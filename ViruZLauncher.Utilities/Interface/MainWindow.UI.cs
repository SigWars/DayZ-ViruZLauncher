...
namespace ViruZLauncher.Utilities.Interface
{
	public partial class MainWindow
	{
		...
		[UIElement] private readonly Button GenerateViruZLauncherManifestButton;
		...
		{
			using (var builder = new Builder(Assembly.GetExecutingAssembly(), "ViruZLauncher.Utilities.Interface.ViruZLauncher.Utilities.glade", null))
			{
		...
		private void BindUIEvents()
		{
			...
			this.GenerateViruZLauncherManifestButton.Clicked += OnGenerateViruZLauncherManifestButtonClicked;
