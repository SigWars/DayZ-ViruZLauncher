...
namespace ViruZLauncher.Launcher.Handlers
{
	...
	public sealed class ConfigHandler
	{
		...
		/// </summary>
		public IViruZLauncherConfiguration Configuration { get; }
		...
		{
			this.Configuration = new ConfigurationBuilder<IViruZLauncherConfiguration>()
		...
		private void InitializeConfigurationFile()
		{
			...
			foreach (var property in typeof(IViruZLauncherConfiguration).GetProperties())
			{
