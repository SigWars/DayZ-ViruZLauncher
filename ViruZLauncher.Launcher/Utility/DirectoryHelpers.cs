...
namespace ViruZLauncher.Launcher.Utility
{
	/// <summary>
	...
	public static class DirectoryHelpers
	{
		...
		{
			return Path.Combine(Path.GetTempPath(), "ViruZLauncher", "launcher");
		}
		...
		/// </summary>
		/// <returns>
		/// The path to either the official ViruZLauncher binaries or a custom launcher, depending on the settings.
		/// </returns>
