...
using ViruZLauncher.Launcher.Interface;
...
namespace ViruZLauncher.Launcher
{
	...
	public static class Program
	{
		...
		private static void Main()
		{
			...
			Log.Info($"ViruZLauncher v{LocalVersionService.GetLocalLauncherVersion()} starting...");
		...
		private static void OnUnhandledException(object sender, UnhandledExceptionEventArgs unhandledExceptionEventArgs)
		{
			...
			if (unhandledException is DllNotFoundException)
			{
				...
				System.Diagnostics.Process.Start("https://github.com/Nihlus/ViruZLauncher/wiki/Common-problems");
			}
