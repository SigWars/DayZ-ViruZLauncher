//
//  IViruZLauncherConfiguration.cs
//
//  Author:
...
namespace ViruZLauncher.Launcher.Configuration
{
	/// <summary>
	/// Configuration file interface.
	/// </summary>
	public interface IViruZLauncherConfiguration
	{
		// Launcher section
		// ...
		...
		/// </summary>
		[Option(Alias = "Game.Name", DefaultValue = "ViruZLauncher")]
