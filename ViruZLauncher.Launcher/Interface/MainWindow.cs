...
using ViruZLauncher.Launcher.Handlers;
using ViruZLauncher.Launcher.Handlers.Protocols;
using ViruZLauncher.Launcher.Services;
using ViruZLauncher.Launcher.Utility;
using ViruZLauncher.Launcher.Utility.Enums;
using Application = Gtk.Application;
using Process = System.Diagnostics.Process;
using Task = System.Threading.Tasks.Task;

namespace ViruZLauncher.Launcher.Interface
{
	/// <summary>
	/// The main UI class for ViruZLauncher. This class acts as a manager for all threaded
	...
	public sealed partial class MainWindow : Gtk.Window
	{
		...
		/// </summary>
		private readonly IViruZLauncherConfiguration Configuration = ConfigHandler.Instance.Configuration;
